package com.example.foodmarketkotlinpractice.ui.home.popular
...
class HomePopularAdapter(private val listData : List<HomeModel>) : RecyclerView.Adapter<HomePopularAdapter.ViewHolder>() {
